...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_download_downloads_token"), "downloads", ["token"], unique=False, schema="download")
...
def downgrade() -> None:
    """Downgrade to None"""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f("ix_download_downloads_token"), table_name="downloads", schema="download")
