from code.environment import CORS_ORIGINS, SERVICE_NAME
...
app = FastAPI(
    ...
    description="""This API provides a set of endpoints for the email service.""",
    version="1.0.0",
)
...
app.include_router(router=router, prefix="/email")
